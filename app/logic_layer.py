...
"""
This module provides the business logic for interacting with the task database.
"""

from app.db_layer import Database

class TaskManager:
    """Manages high-level task operations such as loading, adding, updating, and deleting tasks."""
